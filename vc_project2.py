# hand recognition game using opencv nad mediapipe module
import mediapipe as mp
import cv2
import numpy as np
from mediapipe.framwork.formats import landmark_pb2
import time
import random
...
with mp_hands.Hands(min_detection_confidence=0.8, min_tracking_confidence=0.5) as hands:
    while video.isOpened():
        ...
        color = (255, 0, 255)
        text = cv2.putText(image, "Score", (488, 30), font, 1, color, 4, cv2.LINE_AA)
